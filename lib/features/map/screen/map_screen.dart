...
class _MapScreenState extends State<MapScreen> {
  ...
  void initState() {
    ...
    MyAdsCubit.instance.getCurrentPositions(
      LocationCubit.instance.position!.latitude,
      LocationCubit.instance.position!.longitude,
    );
  }
          ...
          BlocBuilder<MyAdsCubit, MyAdsState>(
            builder: (context, state) {
              return GoogleMap(
                ...
                initialCameraPosition: MyAdsCubit.instance.cameraPosition!,
                onTap: (LatLng latLng) {},
